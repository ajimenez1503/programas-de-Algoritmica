...
EJERCICIO Problema barco: maximizar el numero de toneladas.
...
//compilar g++ maximizarelnumerodetoneladas.cpp -o max -std=gnu++0x
...
//seleccionamos el contenedor com de peso maximo
